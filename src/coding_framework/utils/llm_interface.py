...
class LLMInterface:
    ...
    async def _call_huggingface_model(self, messages: List[BaseMessage], kwargs: Dict[str, Any]) -> str:
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                if attempt < max_retries:
                    ...
                    self.logger.warning("LLM call failed, retrying",
                                      attempt=attempt + 1,
    ...
    async def batch_call(
        ...
        **kwargs,
        ...
        self.logger.info("Starting batch LLM calls",
        ...
        try:
            ...
            self.logger.info("Batch LLM calls completed",
